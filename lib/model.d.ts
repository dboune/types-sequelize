 ...
 */
export type WhereOptions = WhereAttributeHash | AndOperator | OrOperator | Where | Literal | string[] | number[]
 ...
 */
export interface InitOptions extends ModelOptions<any> {
    /**
...
export abstract class Model {
     ...
     */
    public static init<T extends typeof Model>(this: T, attributes: ModelAttributes, options: InitOptions): T
