...
export class QueryInterface {
     ...
     */
    public addConstraint(tableName: string | { schema?: string, tableName?: string }, attributes: string[], options?: AddConstraintOptions | QueryInterfaceOptions): Promise<void>

    /**
     * Removes constraints from a table
     */
    public removeConstraint(tableName: string | { schema?: string, tableName?: string }, constraintName: string, options?: QueryInterfaceOptions): Promise<void>
